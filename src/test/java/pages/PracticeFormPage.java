...
public class PracticeFormPage {
    ...
    public PracticeFormPage openPracticeFormPage() {
        ...
        $x("//*[@class='main-header']").shouldHave(Condition.text("Practice Form"));
        return this;
    }

    public PracticeFormPage enterFirstName(String firstName) {
        $x("//*[@id='firstName']").val("Larry");
        return this;
    }
    ...
    public PracticeFormPage selectDateOfBirth(String year, String month, String day) {
        ...
        $x(String.format("//div[contains(@class, 'react-datepicker__day--0%s') and " +
                "not(contains(@class, 'react-datepicker__day--outside-month'))]", day)).click();
        return this;
    }
    ...
    public PracticeFormPage checkStudentName(String studentName) {
        $x("//td[text()='Student Name']/following-sibling::td").shouldHave(Condition.text(studentName));
        return this;
    }

    public PracticeFormPage checkStudentEmail(String studentEmail) {
        $x("//td[text()='Student Email']/following-sibling::td").shouldHave(Condition.text(studentEmail));
        return this;
    }

    public PracticeFormPage checkStudentGender(String studentGender) {
        $x("//td[text()='Gender']/following-sibling::td").shouldHave(Condition.text(studentGender));
        return this;
    }

    public PracticeFormPage checkMobileNumber(String mobileNumber) {
        $x("//td[text()='Mobile']/following-sibling::td").shouldHave(Condition.text(mobileNumber));
        return this;
    }

    public PracticeFormPage checkDateOfBirth(String dateOfBirth) {
        $x("//td[text()='Date of Birth']/following-sibling::td").shouldHave(Condition.text(dateOfBirth));
        return this;
    }

    public PracticeFormPage checkSubjects(String subjects) {
        $x("//td[text()='Subjects']/following-sibling::td").shouldHave(Condition.text(subjects));
        return this;
    }

    public PracticeFormPage checkPicture(String pictureName) {
        $x("//td[text()='Picture']/following-sibling::td").shouldHave(Condition.text(pictureName));
        return this;
    }

    public PracticeFormPage checkAddress(String address) {
        $x("//td[text()='Address']/following-sibling::td").shouldHave(Condition.text(address));
        return this;
    }

    public PracticeFormPage checkStateAndCity(String StateAndCity) {
        $x("//td[text()='State and City']/following-sibling::td").shouldHave(Condition.text(StateAndCity));
        return this;
    }
}
